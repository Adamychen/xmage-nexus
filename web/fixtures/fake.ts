 ...
 * (Mage.Proxy) para los E2E de navegador. Cada test lo arranca en un puerto
 * libre (`FakeServer.start(0)`; el test publica el asignado vía setFakePort) y
 * responde a las acciones de commands.ts con envelopes
