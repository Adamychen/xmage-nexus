...
export const FORMAT_CONFIGS: Record<DeckFormat, FormatRuleConfig> = {
  ...
  Oathbreaker: {
    ...
    isSingleton: true,
    hasCommander: true,
    scryfallKey: 'oathbreaker',
    description: '60 singleton con Planeswalker + hechizo insignia e identidad de color',
  },
  PennyDreadfulCommander: {
    name: 'PennyDreadfulCommander',
    displayName: 'Penny Dreadful Commander',
    minMain: 100,
    maxMain: 100,
    maxSideboard: 0,
    maxCopies: 1,
    ...
    hasCommander: true,
    scryfallKey: 'penny',
    description: 'Commander 100 singleton solo con cartas legales en Penny Dreadful',
  },
  EuropeanHighlander: {
    name: 'EuropeanHighlander',
    displayName: 'European Highlander',
    minMain: 100,
    maxMain: 100,
    maxSideboard: 0,
    maxCopies: 1,
    ...
    hasCommander: true,
    scryfallKey: '',
    description: '100 singleton con Comandante (sin lista Scryfall: solo tamaño y singleton)',
  },
  CanadianHighlander: {
    name: 'CanadianHighlander',
    displayName: 'Canadian Highlander',
    minMain: 100,
    maxMain: 100,
    maxSideboard: 0,
    maxCopies: 1,
    ...
    hasCommander: true,
    scryfallKey: '',
    description: '100 singleton con Comandante (el sistema de puntos no se valida)',
  },
  Historic: {
    name: 'Historic',
