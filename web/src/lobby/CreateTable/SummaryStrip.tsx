...
export default function SummaryStrip({ form }: { form: CreateTableForm }) {
  ...
  return (
    <div className="create-table-summary-strip">
      ...
      <span className="summary-pill">{form.timeLimit === 'NONE' ? t('lobby','create_summary_no_clock') : t('lobby', 'create_time_min_short', { min: form.timeLimit.replace('MIN__', '') })}</span>
