...
export default function DownloadPanel({ showClearCache = false, showCloseButton = false, onClose, initialScope = 'STANDARD' }: DownloadPanelProps) {
  ...
  const [scope, setScope] = useState<DownloadScope>(initialScope)
  ...
  const handleClearCache = async () => {
    if (await confirmDialog(t('dialogs', 'download_clear') + '?', { danger: true })) {
    ...
    <>
        ...
        <footer className="download-dialog-footer">
          ...
          <div className="footer-action-buttons">
            ...
            {!isRunning && !isPaused && (
              <button type="button" className="download-btn-primary" onClick={handleStart} data-testid="download-start">
