...
con ×/Esc, singular "(1 carta)", arte M10) · chat de partida como espectador. **Límites**:
visor de **exilio** solo con tests (plan2 A.5); `UserActionModal` humano↔humano solo con
tests (plan2 A.6); 3+ jugadores FFA sin verificar en vivo (plan2 A.8).
