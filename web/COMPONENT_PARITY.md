...
| U15 | Sistema | `dialog/PreferencesDialog.java`, `DownloadImagesDialog.java`, `GameEndDialog.java`, `AddLandDialog.java`, `CardInfoWindowDialog.java`, `AboutDialog.java`, `WhatsNewDialog.java` | `settings/SettingsModal.tsx`, `game/GameEndDialog.tsx`, `game/HelpWikiModal.tsx`, `system/AboutModal.tsx`, `system/news.ts`, `system/gameLogs.ts` | ✅ | Auditada y cerrada 2026-09-08 (ver § U15): prefs esenciales ✅ + atajos fijos (diferencia declarada), imágenes retiradas (descarga de cartas/símbolos oculta 2026-09-10: dependía de Cache Storage, no disponible sobre HTTP), fin partida ✅ + duración + auto-log, tierras ✅ + set picker full-art, InfoWindows ✅ (U12), About ✅ + news remoto doble feed (Nexus+XMage vía GitHub releases, gratis) | 2026-09-10 |
