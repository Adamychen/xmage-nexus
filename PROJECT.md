...
> Last updated: 2026-08-25 (contract anti-drift closed; **proxy multi-tenant**: cada WebSocket = su propia sesión XMage — un solo proceso proxy sirve a muchos usuarios, y la misma cuenta se adjunta a la sesión existente; habilita 2+ usuarios en una máquina y el despliegue server cero-instalación)
