...
> Last updated: 2026-08-24 (fix mulligan visible: `autoKeepMulligan` default `false` para el jugador humano + guard de espectador en `eventHandler` (auto-skip para espectadores); el helper E2E fuerza `true`)
